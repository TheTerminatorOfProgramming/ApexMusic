 ...
 *
 */
package com.ttop.app.apex.fragments.player.gradient
...
import com.ttop.app.apex.fragments.other.VolumeFragment
...
class GradientPlayerFragment : AbsPlayerFragment(R.layout.fragment_gradient_player),
    ...
    private fun getQueuePanel(): ApexBottomSheetBehavior<ConstraintLayout> {
        return ApexBottomSheetBehavior.from(binding.playerQueueSheet) as ApexBottomSheetBehavior<ConstraintLayout>
    }
