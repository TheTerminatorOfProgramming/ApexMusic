...
import com.ttop.app.apex.libraries.appintro.AppIntroBase
import com.ttop.app.apex.libraries.appintro.AppIntroPageTransformerType
import com.ttop.app.apex.libraries.appintro.AppIntroViewPagerListener
...
internal class AppIntroViewPagerController(
    ...
    private fun addPagerTouchInterceptor() {
        ...
        viewPagerGestureOverlay.addOnGestureListener(object : GestureOverlayView.OnGestureListener {
