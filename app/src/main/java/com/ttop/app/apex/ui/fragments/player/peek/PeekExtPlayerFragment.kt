...
import com.ttop.app.apex.databinding.FragmentPeekExtPlayerBinding
...
class PeekExtPlayerFragment : AbsPlayerFragment(R.layout.fragment_peek_ext_player),
    View.OnLayoutChangeListener {

    private lateinit var controlsFragment: PeekPlayerControlFragment
    private var lastColor: Int = 0
    private var _binding: FragmentPeekExtPlayerBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentPeekExtPlayerBinding.bind(view)
        setUpPlayerToolbar()
        setUpSubFragments()
        setupRecyclerView()
    ...
    private fun setUpPlayerToolbar() {
        binding.playerToolbar.apply {
            ...
            setOnMenuItemClickListener(this@PeekExtPlayerFragment)
