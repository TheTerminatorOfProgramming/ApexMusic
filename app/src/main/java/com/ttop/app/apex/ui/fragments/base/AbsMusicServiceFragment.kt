...
open class AbsMusicServiceFragment(@LayoutRes layout: Int) : Fragment(layout),
    ...
    val navOptions by lazy {
        navOptions {
            ...
            anim {
                enter = R.anim.apex_fragment_open_enter
                exit = R.anim.apex_fragment_open_exit
                popEnter = R.anim.apex_fragment_close_enter
                popExit = R.anim.apex_fragment_close_exit
            }
        }
    }
