...
import com.ttop.app.apex.service.MusicService.Companion.ACTION_PLAY
...
import com.ttop.app.apex.service.MusicService.Companion.ACTION_STOP
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "ApexMusicApp:Wakelock headset button"
                )
