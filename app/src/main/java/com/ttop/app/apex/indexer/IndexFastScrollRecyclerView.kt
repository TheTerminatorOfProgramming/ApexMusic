package com.ttop.app.apex.indexer
...
class IndexFastScrollRecyclerView : RecyclerView {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            ...
            mScroller?.setIndexBarTextColor(context.accentColor())
            mScroller?.setPreviewTextColor(context.accentColor())

            var font: Int? = null
            if (PreferenceUtil.isCustomFont != "default") {
                when (PreferenceUtil.isCustomFont) {
                    "apex" -> font = R.font.apex_regular
                    "barlow" -> font = R.font.barlow
                    "binjay" -> font = R.font.binjay_regular
                    "caviar" -> font = R.font.caviardreams_regular
                    "dancing" -> font = R.font.dancingscript_regular
                    "drexs" -> font = R.font.drexs_regular
                    "hermanoalto" -> font = R.font.hermanoalto_chisel_regular
                    "hiatus" -> font = R.font.hiatus_regular
                    "jura" -> font = R.font.jura_regular
                    "neue" -> font = R.font.neuebureaugrotesk_regular
                    "nothing" -> font = R.font.nothing_regular
                    "pencil" -> font = R.font.pencil_regular
                    "sixty" -> font = R.font.sixtyfour_regular
                    "teko" -> font = R.font.teko_regular
                }
            ...
            if (PreferenceUtil.isShowScrollbar) {
                ...
                if (PreferenceUtil.scrollbarType) {
                    mScroller?.setIndexBarVisibility(false)
                }
            }else {
                mScroller?.setIndexBarVisibility(false)
        ...
        mScroller?.setIndexBarWidth(100f)
        mScroller?.setIndexBarVibration(true)
    }
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        if (mScroller != null) {
            if (PreferenceUtil.isShowScrollbar) {
                if (PreferenceUtil.scrollbarType) {
                    mScroller?.onSizeChanged(w, h - ApexUtil.dpToMargin(0))
                } else {
                    mScroller?.onSizeChanged(w, h - ApexUtil.dpToMargin(70))
                }
            } else {
