...
class BackupFragment : Fragment(R.layout.fragment_backup), BackupAdapter.BackupClickedListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.backupPath.setOnClickListener {
            ...
            alert.getButton(Dialog.BUTTON_POSITIVE).accentTextColor()
            alert.getButton(Dialog.BUTTON_NEGATIVE).accentTextColor()
            alert.getButton(Dialog.BUTTON_NEUTRAL).accentTextColor()
        }
