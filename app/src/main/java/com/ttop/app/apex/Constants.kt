...
const val TOGGLE_USER_NAME = "toggle_user_name"
...
const val SHOW_UPDATE = "show_update"
const val IS_QUEUE_HIDDEN_PEEK = "is_queue_hidden"
const val WIDGET_TRANSPARENCY = "widget_transparency"
const val WIDGET_COLORS = "widget_colors"
const val PROGRESS_BAR_STYLE = "progress_bar_style"
const val PROGRESS_BAR_ALIGNMENT = "progress_bar_alignment"
const val INTRO_SHOWN = "intro_shown"
const val BT_VOLUME = "bt_volume"
const val BT_CUSTOM_VOLUME = "bt_custom_volume"
const val SAMSUNG_SOUND_PLUGIN = "samsung_sound_plugin"
...
const val WIDGET_IMAGE = "widget_image"
const val WIDGET_IMAGE_FULL = "widget_image_full"
const val WIDGET_PANEL = "widget_panel"
const val MINI_IMAGE = "mini_image"
const val CLASSIC_SHAPE = "classic_shape"
const val FULL_SHAPE = "full_shape"
const val TEXT_ALIGNMENT = "text_alignment"
const val DEV_MODE="dev_mode"
const val EXTENDED_ACCENT = "extended_accent"
const val MINIPLAYER_IMAGE = "miniplayer_image"
const val RESTORE_LEGACY_WIDGETS = "restore_legacy_widgets"
const val RESTORE_FULL_CIRCLE_WIDGET = "restore_full_circle_widget"
const val RESTORE_BIG_WIDGET = "restore_big_widget"
const val USE_NEW_WIDGET = "use_new_widget"
const val SQUARE_WIDGET_TEXT = "square_widget_text"
const val SQUARE_WIDGET_COLORED = "square_widget_colored"
...
const val DISMISS_FAILSAFE = "dismiss_failsafe"
const val FULL_BLUR = "full_blur"
const val CLASSIC_BLUR = "classic_blur"
const val UPDATE_CHECKED = "update_checked"
const val UPDATE_FREQUENCY = "update_frequency"
const val WEEK_OF_YEAR = "week_of_year"
const val MONTH_OF_YEAR = "month_of_year"
const val DAY_OF_YEAR = "day_of_year"
const val UPDATE_SOURCE = "update_source"
const val UPDATE_CHANNEL = "update_channel"
const val DISABLE_WIDGETS = "disable_widgets"
const val CUSTOM_VOLUME = "custom_volume"
const val HEADSET_VOLUME = "headset_volume"
const val INTERNET_CONNECTED = "internet_connected"
const val WIDGET_BUTTON_COLOR = "widget_button_color"
const val WIDGET_CUSTOM_COLOR = "widget_custom_color"
const val SHOW_WIDGET_PROGRESSBAR = "show_widget_progressbar"
const val PROGRESSBAR_COLOR = "progressbar_color"
const val QUEUE_SHAPE = "queue_shape"
const val WIDGET_QUEUE_IMAGE = "widget_queue_image"
const val QUEUE_BLUR = "queue_blur"
const val QUEUE_REVERSE = "queue_reverse"