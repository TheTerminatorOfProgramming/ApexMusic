...
public final class TintHelper {
    ...
    public static void setTint(@NonNull RadioButton radioButton, @ColorInt int color, boolean useDarker) {
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                ATHColorUtil.INSTANCE.stripAlpha(ContextCompat.getColor(radioButton.getContext(),
    ...
    public static void setTintAuto(final @NonNull View view, final @ColorInt int color,
        ...
        if (!background) {
            ...
            if (!background && view.getBackground() instanceof RippleDrawable) {
                ...
                final int checked = ATHColorUtil.INSTANCE.adjustAlpha(color, 0.4f);
    ...
    public static void setTintSelector(@NonNull View view, @ColorInt final int color, final boolean darker,
        ...
        final boolean isColorLight = ATHColorUtil.INSTANCE.isColorLight(color);
        ...
        final int pressed = ATHColorUtil.INSTANCE.shiftColor(color, darker ? 0.9f : 1.1f);
        final int activated = ATHColorUtil.INSTANCE.shiftColor(color, darker ? 1.1f : 0.9f);
    ...
    private static ColorStateList createSwitchDrawableTintList(@NonNull Context context, @ColorInt int tint,
        ...
        int lighterTint = ATHColorUtil.INSTANCE.blendColors(tint, Color.WHITE, 0.4f);
        int darkerTint = ATHColorUtil.INSTANCE.shiftColor(tint, 0.8f);
        if (useDarker) {
        ...
        if (!compatSwitch) {
            normal = ATHColorUtil.INSTANCE.stripAlpha(normal);
        }
