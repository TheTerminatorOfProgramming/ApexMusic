...
class SeekRwdPreference @JvmOverloads constructor(
    context: Context,
...
class SeekRwdPreferenceDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding.slider.apply {
            addAccentColor()
            value = PreferenceUtil.rewindDuration.toFloat()
        ...
        return materialDialog(R.string.pref_title_rewind_duration)
    ...
    companion object {
        fun newInstance(): SeekRwdPreferenceDialog {
            return SeekRwdPreferenceDialog()
        }
    }
}