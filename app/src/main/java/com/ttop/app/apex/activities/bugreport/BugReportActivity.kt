 ...
 *
 */
package com.ttop.app.apex.activities.bugreport
...
import com.ttop.app.apex.activities.bugreport.model.DeviceInfo
import com.ttop.app.apex.activities.bugreport.model.Report
import com.ttop.app.apex.activities.bugreport.model.github.ExtraInfo
import com.ttop.app.apex.activities.bugreport.model.github.GithubLogin
import com.ttop.app.apex.activities.bugreport.model.github.GithubTarget
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    private fun sendBugReport(login: GithubLogin) {
        ...
        val target = GithubTarget("TheTerminatorOfProgramming", "Apex")
    ...
    companion object {
        ...
        private const val ISSUE_TRACKER_LINK = "https://github.com/TheTerminatorOfProgramming/ApexMusic"
    }
}
