 ...
 *
 */
package com.ttop.app.apex.fragments.player.classic
...
class ClassicPlayerFragment : AbsPlayerFragment(R.layout.fragment_classic_player),
    ...
    private fun getQueuePanel(): ApexBottomSheetBehavior<MaterialCardView> {
        return ApexBottomSheetBehavior.from(binding.playerQueueSheet) as ApexBottomSheetBehavior<MaterialCardView>
    }
