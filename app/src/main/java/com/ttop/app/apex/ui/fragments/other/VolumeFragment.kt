...
import com.ttop.app.apex.databinding.FragmentVolumeBinding
...
class VolumeFragment : Fragment(), Slider.OnChangeListener, OnAudioVolumeChangedListener,
    ...
    override fun onAudioVolumeChanged(currentVolume: Int, maxVolume: Int) {
        if (_binding != null) {
            ...
            binding.volumeDown.setImageResource(if (currentVolume == 0) R.drawable.ic_volume_off else R.drawable.ic_minus)
        }
    }
    ...
    override fun onValueChange(slider: Slider, value: Float, fromUser: Boolean) {
        ...
        binding.volumeDown.setImageResource(if (value == 0f) R.drawable.ic_volume_off else R.drawable.ic_minus)
    }
