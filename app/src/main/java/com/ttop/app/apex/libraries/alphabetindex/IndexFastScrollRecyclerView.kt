...
class IndexFastScrollRecyclerView : RecyclerView {
    ...
    var mIndexBarWidth = 24f
    var mIndexBarMarginLeft = 0f
    var mIndexBarMarginRight = 0f
    var mIndexBarMarginTop = if (ApexUtil.isTablet) {
    ...
    var mIndexBarMarginBottom = if (ApexUtil.isTablet) {
        if (ApexUtil.isLandscape) {
            10f
        }else {
            20f
