...
import code.name.monkey.retro.EXTRA_GENRE
import code.name.monkey.retro.R
import code.name.monkey.retro.adapter.GenreAdapter
import code.name.monkey.retro.fragments.ReloadType
import code.name.monkey.retro.fragments.base.AbsRecyclerViewFragment
