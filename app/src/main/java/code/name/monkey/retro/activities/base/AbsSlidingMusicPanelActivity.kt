 ...
 *
 */
package code.name.monkey.retro.activities.base
...
import code.name.monkey.retro.RetroBottomSheetBehavior
import code.name.monkey.retro.databinding.SlidingMusicPanelLayoutBinding
import code.name.monkey.retro.extensions.*
import code.name.monkey.retro.fragments.LibraryViewModel
import code.name.monkey.retro.fragments.NowPlayingScreen
import code.name.monkey.retro.fragments.NowPlayingScreen.*
import code.name.monkey.retro.fragments.base.AbsPlayerFragment
import code.name.monkey.retro.fragments.other.MiniPlayerFragment
import code.name.monkey.retro.fragments.player.adaptive.AdaptiveFragment
import code.name.monkey.retro.fragments.player.blur.BlurPlayerFragment
import code.name.monkey.retro.fragments.player.card.CardFragment
import code.name.monkey.retro.fragments.player.cardblur.CardBlurFragment
import code.name.monkey.retro.fragments.player.circle.CirclePlayerFragment
import code.name.monkey.retro.fragments.player.classic.ClassicPlayerFragment
import code.name.monkey.retro.fragments.player.color.ColorFragment
import code.name.monkey.retro.fragments.player.fit.FitFragment
import code.name.monkey.retro.fragments.player.flat.FlatPlayerFragment
import code.name.monkey.retro.fragments.player.full.FullPlayerFragment
import code.name.monkey.retro.fragments.player.gradient.GradientPlayerFragment
import code.name.monkey.retro.fragments.player.material.MaterialFragment
import code.name.monkey.retro.fragments.player.normal.PlayerFragment
import code.name.monkey.retro.fragments.player.peek.PeekPlayerFragment
import code.name.monkey.retro.fragments.player.plain.PlainPlayerFragment
import code.name.monkey.retro.fragments.player.simple.SimplePlayerFragment
import code.name.monkey.retro.fragments.player.tiny.TinyPlayerFragment
import code.name.monkey.retro.fragments.queue.PlayingQueueFragment
import code.name.monkey.retro.helper.MusicPlayerRemote
import code.name.monkey.retro.model.CategoryInfo
import code.name.monkey.retro.util.PreferenceUtil
import code.name.monkey.retro.util.ViewUtil
