package code.name.monkey.retro.cast

import androidx.core.net.toUri
import code.name.monkey.retro.cast.RetroWebServer.Companion.MIME_TYPE_AUDIO
import code.name.monkey.retro.cast.RetroWebServer.Companion.PART_COVER_ART
import code.name.monkey.retro.cast.RetroWebServer.Companion.PART_SONG
