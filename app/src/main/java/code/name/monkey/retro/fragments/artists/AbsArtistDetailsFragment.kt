package code.name.monkey.retro.fragments.artists
...
import code.name.monkey.retro.databinding.FragmentArtistDetailsBinding
...
import code.name.monkey.retro.helper.SortOrder
...
import code.name.monkey.retro.network.model.LastFmArtist
import code.name.monkey.retro.repository.RealRepository
import code.name.monkey.retro.util.*
