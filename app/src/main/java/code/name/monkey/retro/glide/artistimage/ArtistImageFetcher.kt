package code.name.monkey.retro.glide.artistimage

import android.content.Context
import code.name.monkey.retro.model.Data
import code.name.monkey.retro.model.DeezerResponse
import code.name.monkey.retro.network.DeezerService
