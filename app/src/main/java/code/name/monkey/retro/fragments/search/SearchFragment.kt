 ...
 *
 */
package code.name.monkey.retro.fragments.search
...
import code.name.monkey.retro.adapter.SearchAdapter
import code.name.monkey.retro.databinding.FragmentSearchBinding
import code.name.monkey.retro.extensions.accentColor
import code.name.monkey.retro.extensions.dipToPix
import code.name.monkey.retro.extensions.focusAndShowKeyboard
import code.name.monkey.retro.extensions.showToast
import code.name.monkey.retro.fragments.base.AbsMainActivityFragment
import code.name.monkey.retro.util.PreferenceUtil
import code.name.monkey.retro.views.addAlpha
