...
import code.name.monkey.retro.adapter.album.AlbumAdapter
import code.name.monkey.retro.adapter.artist.ArtistAdapter
import code.name.monkey.retro.adapter.song.ShuffleButtonSongAdapter
import code.name.monkey.retro.adapter.song.SongAdapter
import code.name.monkey.retro.databinding.FragmentPlaylistDetailBinding
import code.name.monkey.retro.db.toSong
import code.name.monkey.retro.extensions.dipToPix
