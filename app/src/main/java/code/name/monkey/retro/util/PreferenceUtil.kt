...
import code.name.monkey.retro.extensions.getIntRes
import code.name.monkey.retro.extensions.getStringOrDefault
import code.name.monkey.retro.fragments.AlbumCoverStyle
import code.name.monkey.retro.fragments.GridStyle
import code.name.monkey.retro.fragments.NowPlayingScreen
import code.name.monkey.retro.fragments.folder.FoldersFragment
import code.name.monkey.retro.helper.SortOrder.*
import code.name.monkey.retro.model.CategoryInfo
import code.name.monkey.retro.transform.*
import code.name.monkey.retro.util.theme.ThemeMode
import code.name.monkey.retro.views.TopAppBarLayout
...
object PreferenceUtil {
    ...
    val isShuffleModeOn
        get() = sharedPreferences.getBoolean(TOGGLE_SHUFFLE, false)
