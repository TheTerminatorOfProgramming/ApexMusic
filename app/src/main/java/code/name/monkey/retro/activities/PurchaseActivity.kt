...
import code.name.monkey.retro.BuildConfig
import code.name.monkey.retro.Constants.PRO_VERSION_PRODUCT_ID
import code.name.monkey.retro.R
import code.name.monkey.retro.activities.base.AbsBaseActivity
import code.name.monkey.retro.databinding.ActivityProVersionBinding
