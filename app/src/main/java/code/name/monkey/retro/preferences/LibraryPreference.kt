...
package code.name.monkey.retro.preferences
...
import code.name.monkey.retro.adapter.CategoryInfoAdapter
import code.name.monkey.retro.databinding.PreferenceDialogLibraryCategoriesBinding
