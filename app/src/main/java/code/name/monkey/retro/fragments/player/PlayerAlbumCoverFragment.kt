 ...
 *
 */
package code.name.monkey.retro.fragments.player
...
import code.name.monkey.retro.LYRICS_TYPE
import code.name.monkey.retro.R
import code.name.monkey.retro.SHOW_LYRICS
import code.name.monkey.retro.adapter.album.AlbumCoverPagerAdapter
import code.name.monkey.retro.adapter.album.AlbumCoverPagerAdapter.AlbumCoverFragment
import code.name.monkey.retro.databinding.FragmentPlayerAlbumCoverBinding
import code.name.monkey.retro.extensions.isColorLight
import code.name.monkey.retro.extensions.surfaceColor
import code.name.monkey.retro.fragments.NowPlayingScreen.*
import code.name.monkey.retro.fragments.base.AbsMusicServiceFragment
import code.name.monkey.retro.fragments.base.goToLyrics
import code.name.monkey.retro.helper.MusicPlayerRemote
import code.name.monkey.retro.helper.MusicProgressViewUpdateHelper
import code.name.monkey.retro.lyrics.CoverLrcView
import code.name.monkey.retro.model.lyrics.Lyrics
import code.name.monkey.retro.transform.CarousalPagerTransformer
import code.name.monkey.retro.transform.ParallaxPagerTransformer
import code.name.monkey.retro.util.LyricUtil
import code.name.monkey.retro.util.LyricsType
