...
import code.name.monkey.retro.model.Contributor
import code.name.monkey.retro.util.RetroUtil.openUrl
import code.name.monkey.retro.views.RetroShapeableImageView
