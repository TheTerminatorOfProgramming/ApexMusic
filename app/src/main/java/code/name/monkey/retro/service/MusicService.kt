 ...
 */
package code.name.monkey.retro.service
...
import code.name.monkey.retro.*
import code.name.monkey.retro.activities.LockScreenActivity
import code.name.monkey.retro.appwidgets.*
import code.name.monkey.retro.auto.AutoMediaIDHelper
import code.name.monkey.retro.auto.AutoMusicProvider
import code.name.monkey.retro.glide.BlurTransformation
import code.name.monkey.retro.glide.GlideApp
import code.name.monkey.retro.glide.RetroGlideExtension.getSongModel
import code.name.monkey.retro.helper.MusicPlayerRemote.isCasting
import code.name.monkey.retro.helper.ShuffleHelper.makeShuffleList
import code.name.monkey.retro.model.Song
import code.name.monkey.retro.model.Song.Companion.emptySong
import code.name.monkey.retro.model.smartplaylist.AbsSmartPlaylist
import code.name.monkey.retro.providers.HistoryStore
import code.name.monkey.retro.providers.MusicPlaybackQueueStore
import code.name.monkey.retro.providers.SongPlayCountStore
import code.name.monkey.retro.service.AudioFader.Companion.startFadeAnimator
import code.name.monkey.retro.service.notification.PlayingNotification
import code.name.monkey.retro.service.notification.PlayingNotificationClassic
import code.name.monkey.retro.service.notification.PlayingNotificationImpl24
import code.name.monkey.retro.service.playback.Playback
import code.name.monkey.retro.service.playback.Playback.PlaybackCallbacks
import code.name.monkey.retro.util.MusicUtil.getMediaStoreAlbumCoverUri
import code.name.monkey.retro.util.MusicUtil.getSongFileUri
import code.name.monkey.retro.util.MusicUtil.isFavorite
import code.name.monkey.retro.util.MusicUtil.toggleFavorite
import code.name.monkey.retro.util.PackageValidator
import code.name.monkey.retro.util.PreferenceUtil.crossFadeDuration
import code.name.monkey.retro.util.PreferenceUtil.isAlbumArtOnLockScreen
import code.name.monkey.retro.util.PreferenceUtil.isBluetoothSpeaker
import code.name.monkey.retro.util.PreferenceUtil.isBlurredAlbumArt
import code.name.monkey.retro.util.PreferenceUtil.isClassicNotification
import code.name.monkey.retro.util.PreferenceUtil.isHeadsetPlugged
import code.name.monkey.retro.util.PreferenceUtil.isLockScreen
import code.name.monkey.retro.util.PreferenceUtil.isPauseOnZeroVolume
import code.name.monkey.retro.util.PreferenceUtil.playbackSpeed
import code.name.monkey.retro.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import code.name.monkey.retro.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import code.name.monkey.retro.util.RetroUtil
import code.name.monkey.retro.volume.AudioVolumeObserver
import code.name.monkey.retro.volume.OnAudioVolumeChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    override fun onCreate() {
        ...
        restoreState()
        sendBroadcast(Intent("code.name.monkey.retro.RETRO_MUSIC_SERVICE_CREATED"))
    ...
    override fun onDestroy() {
        ...
        wakeLock?.release()
        sendBroadcast(Intent("code.name.monkey.retro.RETRO_MUSIC_SERVICE_DESTROYED"))
    }
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "code.name.monkey.retro"
