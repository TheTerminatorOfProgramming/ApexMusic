 ...
 *
 */
package code.name.monkey.retro.fragments.base
...
import code.name.monkey.retro.activities.MainActivity
import code.name.monkey.retro.activities.tageditor.AbsTagEditorActivity
import code.name.monkey.retro.activities.tageditor.SongTagEditorActivity
import code.name.monkey.retro.db.PlaylistEntity
import code.name.monkey.retro.db.toSongEntity
import code.name.monkey.retro.dialogs.*
import code.name.monkey.retro.extensions.currentFragment
import code.name.monkey.retro.extensions.hide
import code.name.monkey.retro.extensions.keepScreenOn
import code.name.monkey.retro.extensions.whichFragment
import code.name.monkey.retro.fragments.NowPlayingScreen
import code.name.monkey.retro.fragments.ReloadType
...
import code.name.monkey.retro.interfaces.IPaletteColorHolder
