 ...
 *
 */
package code.name.monkey.retro.fragments.player.circle
...
import code.name.monkey.retro.databinding.FragmentCirclePlayerBinding
import code.name.monkey.retro.extensions.*
import code.name.monkey.retro.fragments.MusicSeekSkipTouchListener
import code.name.monkey.retro.fragments.base.AbsPlayerControlsFragment
import code.name.monkey.retro.fragments.base.AbsPlayerFragment
import code.name.monkey.retro.fragments.base.goToAlbum
import code.name.monkey.retro.fragments.base.goToArtist
import code.name.monkey.retro.glide.GlideApp
import code.name.monkey.retro.glide.GlideRequest
import code.name.monkey.retro.glide.RetroGlideExtension
import code.name.monkey.retro.glide.crossfadeListener
import code.name.monkey.retro.helper.MusicPlayerRemote
import code.name.monkey.retro.helper.MusicProgressViewUpdateHelper
import code.name.monkey.retro.helper.MusicProgressViewUpdateHelper.Callback
import code.name.monkey.retro.helper.PlayPauseButtonOnClickHandler
import code.name.monkey.retro.misc.SimpleOnSeekbarChangeListener
