...
import code.name.monkey.retro.activities.base.AbsBaseActivity
import code.name.monkey.retro.databinding.ActivityShareInstagramBinding
import code.name.monkey.retro.extensions.setLightStatusBar
import code.name.monkey.retro.extensions.setStatusBarColor
...
import code.name.monkey.retro.util.Share
