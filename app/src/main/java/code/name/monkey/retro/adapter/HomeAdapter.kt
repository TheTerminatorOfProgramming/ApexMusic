 ...
 *
 */
package code.name.monkey.retro.adapter
...
import code.name.monkey.retro.fragments.home.HomeFragment
...
import code.name.monkey.retro.interfaces.IGenreClickListener
import code.name.monkey.retro.model.*
