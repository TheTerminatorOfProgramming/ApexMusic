 ...
 *
 */
package code.name.monkey.retro.activities.bugreport
...
import code.name.monkey.retro.activities.base.AbsThemeActivity
import code.name.monkey.retro.activities.bugreport.model.DeviceInfo
import code.name.monkey.retro.activities.bugreport.model.Report
import code.name.monkey.retro.activities.bugreport.model.github.ExtraInfo
import code.name.monkey.retro.activities.bugreport.model.github.GithubLogin
import code.name.monkey.retro.activities.bugreport.model.github.GithubTarget
import code.name.monkey.retro.databinding.ActivityBugReportBinding
