package code.name.monkey.retro.glide

import android.content.Context
import android.graphics.drawable.Drawable
import code.name.monkey.appthemehelper.ThemeStore.Companion.accentColor
import code.name.monkey.appthemehelper.util.TintHelper
import code.name.monkey.retro.App.Companion.getContext
import code.name.monkey.retro.Constants.USER_BANNER
import code.name.monkey.retro.Constants.USER_PROFILE
import code.name.monkey.retro.R
import code.name.monkey.retro.glide.artistimage.ArtistImage
import code.name.monkey.retro.glide.audiocover.AudioFileCover
...
import code.name.monkey.retro.util.ArtistSignatureUtil
import code.name.monkey.retro.util.CustomArtistImageUtil.Companion.getFile
import code.name.monkey.retro.util.CustomArtistImageUtil.Companion.getInstance
