 ...
 *
 */
package code.name.monkey.retro.fragments.other
...
import code.name.monkey.retro.activities.tageditor.TagWriter
import code.name.monkey.retro.databinding.FragmentLyricsBinding
import code.name.monkey.retro.databinding.FragmentNormalLyricsBinding
import code.name.monkey.retro.databinding.FragmentSyncedLyricsBinding
import code.name.monkey.retro.extensions.accentColor
import code.name.monkey.retro.extensions.materialDialog
import code.name.monkey.retro.extensions.textColorSecondary
import code.name.monkey.retro.extensions.uri
...
import code.name.monkey.retro.lyrics.LrcView
import code.name.monkey.retro.model.AudioTagInfo
import code.name.monkey.retro.model.Song
import code.name.monkey.retro.util.FileUtils
import code.name.monkey.retro.util.LyricUtil
import code.name.monkey.retro.util.RetroUtil
import code.name.monkey.retro.util.UriUtil
