...
import code.name.monkey.retro.adapter.artist.ArtistAdapter
import code.name.monkey.retro.extensions.surfaceColor
import code.name.monkey.retro.fragments.GridStyle
import code.name.monkey.retro.fragments.ReloadType
import code.name.monkey.retro.fragments.base.AbsRecyclerViewCustomGridSizeFragment
import code.name.monkey.retro.helper.MusicPlayerRemote
import code.name.monkey.retro.helper.SortOrder.ArtistSortOrder
import code.name.monkey.retro.interfaces.IAlbumArtistClickListener
import code.name.monkey.retro.interfaces.IArtistClickListener
...
class ArtistsFragment : AbsRecyclerViewCustomGridSizeFragment<ArtistAdapter, GridLayoutManager>(),
    ...
    override fun loadGridSizeTabletLand(): Int {
        return PreferenceUtil.artistGridSizeTabletLand
    }
