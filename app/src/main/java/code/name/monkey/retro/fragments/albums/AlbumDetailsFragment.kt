 ...
 *
 */
package code.name.monkey.retro.fragments.albums
...
import code.name.monkey.retro.EXTRA_ALBUM_ID
import code.name.monkey.retro.EXTRA_ARTIST_ID
import code.name.monkey.retro.EXTRA_ARTIST_NAME
import code.name.monkey.retro.R
import code.name.monkey.retro.activities.tageditor.AbsTagEditorActivity
import code.name.monkey.retro.activities.tageditor.AlbumTagEditorActivity
import code.name.monkey.retro.adapter.album.HorizontalAlbumAdapter
import code.name.monkey.retro.adapter.song.SimpleSongAdapter
import code.name.monkey.retro.databinding.FragmentAlbumDetailsBinding
import code.name.monkey.retro.dialogs.AddToPlaylistDialog
import code.name.monkey.retro.dialogs.DeleteSongsDialog
...
import code.name.monkey.retro.glide.RetroGlideExtension
import code.name.monkey.retro.glide.SingleColorTarget
import code.name.monkey.retro.helper.MusicPlayerRemote
import code.name.monkey.retro.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_A_Z
import code.name.monkey.retro.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import code.name.monkey.retro.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import code.name.monkey.retro.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
import code.name.monkey.retro.interfaces.IAlbumClickListener
...
import code.name.monkey.retro.network.Result
import code.name.monkey.retro.network.model.LastFmAlbum
import code.name.monkey.retro.repository.RealRepository
