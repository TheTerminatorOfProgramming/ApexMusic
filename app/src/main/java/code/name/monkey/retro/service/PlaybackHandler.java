...
import static code.name.monkey.retro.service.MusicService.DUCK;
import static code.name.monkey.retro.service.MusicService.META_CHANGED;
import static code.name.monkey.retro.service.MusicService.PLAY_STATE_CHANGED;
import static code.name.monkey.retro.service.MusicService.REPEAT_MODE_NONE;
import static code.name.monkey.retro.service.MusicService.TRACK_ENDED;
import static code.name.monkey.retro.service.MusicService.TRACK_WENT_TO_NEXT;
